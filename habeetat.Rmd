...
> Hemos plantado más de 100 margenes con flores autoctonas! 
...
```
El proyecto ya se ha completado para la primavera 2020 con más de 100 agricultores implicados.  

```{r, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", fig.align="center"}
# All defaults
include_graphics("media/summary_HABEETAT.jpg")
```
La evidencia científica muestra que cultivar con las abejas mejora el rendimiento del cultivo. La mayoria de practicas recomendadas no son nuevas, y pretenden recuperar el sentido comun a la hora de cuidar la tierra: Puedes descargarte el tríptico [aquí](media/HABEETAT.pdf).
